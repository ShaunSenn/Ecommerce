    ...
    render() {
        ...
        return (
            <div className={`${className} order-summary`}>
                <UnderlinedTitle className='order-summary__title' title='Order Summary'value={`$${subtotal}`}/>
                <InfoTitle className='order-summary__subtotal' title={`${amtStickers} stickers`} value='$7.96'/>
